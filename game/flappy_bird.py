...
class GameState:
    def __init__(self):
        ...
        newPipe1 = getRandomPipe() #returns dictionary of lower and upper pipe locations
...
def showScore(score):
    ...
    for digit in scoreDigits: #blit: draw one image onto another (draw something onto SCREEN surface)
