...
def train(model, start, beginning_episode = 0, beginning_iteration = 0):
...
def main(mode):
    ...
    if args.mode == 'test':
        ...
        torch.save(model, args.model_save_path + "/INIT_MODEL.pth")
        ...
        train(model, start,args.beginning_episode,args.beginning_iteration)
